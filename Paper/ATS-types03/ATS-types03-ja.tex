...
\noindent {\it Proof.}
We can readily prove (1), (2) and (3) by structural induction on D.
When proving (1) and (2),
we need to make use of the regularity rules (reg-subst) and (reg-cut), respectively.

\noindent Given a derivation D,
we use h(D) for the height of D,
which can be defined in a standard manner.
