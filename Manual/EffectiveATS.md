...
* [Redis を用いたプロセス間通信 (Inter-Process Communication based on Redis)](http://jats-ug.metasepi.org/doc/ATS2/EXAMPLE/EFFECTIVATS/IPC-hiredis/main.html)
...
* [最小の HTTP サーバを実装する (Implementing a minimal http-server)](http://jats-ug.metasepi.org/doc/ATS2/EXAMPLE/EFFECTIVATS/http-server/main.html)
